...
class ChatInterface(Frame):
    ...
    def __init__(self, master=None):
       ...
       # color_theme.add_command(label='Mkbhd',command=self.MKBHD)
        ...
        help_option.add_command(label="About Anna", command=self.msg)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("Anna v1.0","Anna is a chatbot which can guide you through adverse drug reactions and Blood pressure.")

    def about(self):
        tkinter.messagebox.showinfo("Anna Developers","Miss. Anagha Kale")
